...
const Footer = () => {
  return (
    <footer className="text-white flex flex-col justify-center items-center bg-neutral-900 pt-8" >
        <section className="flex flex-col gap-6 pl-8">
            <div>
                <h2 className="text-xl font-bold">Imports Solution</h2>
                <p className="text-xs font-bold text-gray-400 pt-2">Sua loja especializada em iPhones premium. Oferecemos os melhores modelos com garantia e atendimento de qualidade.</p>
            </div>
            ...
            <div>
                ...
                <p className="text-xs font-bold text-gray-400 pt-2 flex flex-row items-center gap-2">
                    ...
                    Rua Principal, 12 São Paulo, SP 01234-567
                    </p>
            </div>
